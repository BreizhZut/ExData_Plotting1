...
## Ploting histogram of the Glabal Active Power
## Open png device
png(filename="plot1.png")
## Make the plot
hist(dataHCG$Global_active_power,col="red",main="Global Active Power",xlab="Global Active Power (kilowatts)",yaxp=c(0,1200,6))
## Close png device
dev.off()